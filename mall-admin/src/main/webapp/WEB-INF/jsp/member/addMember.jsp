...
<body>
	...
	<div class="row">
		...
		<div class="col-sm-10">
			<h4>사원 추가 </h4>
			<!-- action 요청 -->
			<form method="post" id="addMemberForm" action="${pageContext.request.contextPath }/member/addMember">
				...
				<label> 회원레벨 : </label>
				<input  class="form-control type="text" name="memberLevel" value="employee" readonly>
				<button id="addMember" type="button" class="btn btn-dark">회원가입</button>
			</form> 
		</div>
	</div>
</body>
